  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-black text-white text-center p-6 overflow-y-auto relative">
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto">
        <h1 className="text-4xl md:text-5xl font-bold mb-8 text-gray-100 drop-shadow-[0_0_10px_rgba(255,0,0,0.5)]">
          Phòng thu âm Jozo
        </h1>

        <div className="mb-8 p-6 bg-black/60 backdrop-blur-md rounded-lg border border-red-500/30 max-w-md mx-auto">
          <div className="relative inline-block mb-4">
            <span className="inline-block text-red-500 text-2xl font-bold">
              ●
            </span>
            <span className="ml-2 text-2xl font-bold text-red-500 relative">
              ON AIR
              <span className="absolute inset-0 bg-red-500 opacity-30 blur-md"></span>
            </span>
          </div>
          <p className="text-xl my-3 text-gray-200">Đang ghi âm và sản xuất</p>
          <p className="text-xl my-3 text-gray-200">Vui lòng giữ yên lặng</p>
        ...
        <div className="italic opacity-80 mt-8 bg-black/30 p-4 rounded-lg backdrop-blur-sm max-w-md mx-auto">
        ...
        <div className="flex flex-wrap justify-center gap-8 mt-8 w-full">
          <div className="bg-black/60 backdrop-blur-md rounded-lg p-6 min-w-[250px] flex-1 shadow-lg border border-white/10 hover:border-red-500/30 transition-all duration-300 transform hover:-translate-y-1">
        ...
        <div className="mt-8 bg-black/70 backdrop-blur-md p-4 rounded-lg max-w-md mx-auto border border-gray-800">
        ...
        {/* Studio Controls */}
        <div className="mt-6 bg-black/70 backdrop-blur-md p-4 rounded-lg max-w-md mx-auto border border-red-500/20">
        ...
        <div className="mt-6 opacity-60 bg-black/50 inline-block mx-auto py-1 px-3 rounded-full backdrop-blur-sm">
